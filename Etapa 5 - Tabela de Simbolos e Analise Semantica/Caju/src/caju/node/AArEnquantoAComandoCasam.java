...
public final class AArEnquantoAComandoCasam extends PAComandoCasam
{
    private PAExp _aExp_;
    private PAComando _aComando_;

    public AArEnquantoAComandoCasam()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AArEnquantoAComandoCasam(
    ...
    {
        ((Analysis) sw).caseAArEnquantoAComandoCasam(this);
    }
