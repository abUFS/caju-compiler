...
public final class AArSeAComandoCasam extends PAComandoCasam
{
    private PAExp _aExp_;
    private PAComando _aComando_;

    public AArSeAComandoCasam()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseAArSeAComandoCasam(this);
    }
