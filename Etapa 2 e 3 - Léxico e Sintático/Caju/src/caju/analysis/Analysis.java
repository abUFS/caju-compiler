...
public interface Analysis extends Switch
{
    ...
    void caseAOutraComando(AOutraComando node);
    ...
    void caseAEnquantoOutras(AEnquantoOutras node);
    void caseAParaOutras(AParaOutras node);
    void caseAParaCadaOutras(AParaCadaOutras node);
    void caseAAtribOutras(AAtribOutras node);
    void caseARetorneOutras(ARetorneOutras node);
    void caseABlocoOutras(ABlocoOutras node);
    void caseAChamadaOutras(AChamadaOutras node);
