...
public final class AArBlocoAComandoSemCasam extends PAComandoSemCasam
{
    private PABloco _aBloco_;

    public AArBlocoAComandoSemCasam()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AArBlocoAComandoSemCasam(
    ...
    {
        ((Analysis) sw).caseAArBlocoAComandoSemCasam(this);
    }
