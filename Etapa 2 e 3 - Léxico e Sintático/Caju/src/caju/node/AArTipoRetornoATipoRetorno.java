...
public final class AArTipoRetornoATipoRetorno extends PATipoRetorno
{
    private PATipo _aTipo_;

    public AArTipoRetornoATipoRetorno()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AArTipoRetornoATipoRetorno(
    ...
    {
        ((Analysis) sw).caseAArTipoRetornoATipoRetorno(this);
    }
