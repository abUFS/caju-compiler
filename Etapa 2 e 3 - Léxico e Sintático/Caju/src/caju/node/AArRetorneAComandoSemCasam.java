...
public final class AArRetorneAComandoSemCasam extends PAComandoSemCasam
{
    private PAExp _aExp_;

    public AArRetorneAComandoSemCasam()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AArRetorneAComandoSemCasam(
    ...
    {
        ((Analysis) sw).caseAArRetorneAComandoSemCasam(this);
    }
