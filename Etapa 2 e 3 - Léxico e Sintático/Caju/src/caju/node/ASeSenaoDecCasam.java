...
public final class ASeSenaoDecCasam extends PDecCasam
{
    private TSe _se_;
    private TAbreParenteses _abreParenteses_;
    private PExp _exp_;
    private TFechaParenteses _fechaParenteses_;
    private PDecCasam _esq_;
    private TSenao _senao_;
    private PDecCasam _dir_;

    public ASeSenaoDecCasam()
    {
        // Constructor
    }
    ...
    public ASeSenaoDecCasam(
        ...
        @SuppressWarnings("hiding") PDecCasam _esq_,
        @SuppressWarnings("hiding") TSenao _senao_,
        @SuppressWarnings("hiding") PDecCasam _dir_)
    {
        // Constructor
        setSe(_se_);
    ...
    {
        ((Analysis) sw).caseASeSenaoDecCasam(this);
    }
    ...
    public PDecCasam getEsq()
    {
        return this._esq_;
    }

    public void setEsq(PDecCasam node)
    {
        if(this._esq_ != null)
        {
    ...
    public PDecCasam getDir()
    {
        return this._dir_;
    }

    public void setDir(PDecCasam node)
    {
        if(this._dir_ != null)
        {
